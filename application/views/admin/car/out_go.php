  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> لیست خروجی  وسایط نقلیه ها </li>
      </ol>
            ...
            <?php $counter=1; foreach($vehicle as $item){ ?>
             <tr>
               ...
               <!-- <td><?echo date($today);?></td>-->
                <td><a href="<?=base_url()?>vehicle/edit/<?=$item->id;?>" class="btn btn-success">Edit</a></td>
                <td><a href="<?=base_url()?>vehicle/delete/<?=$item->id;?>" class="btn btn-danger">Delete</a></td>
                    <?php 
